"""
Tests where other_from_sdks is not specified, but other_to_sdks is. The
expected apps are the apps that used to use all SDKs and migrated to other SDKs
except PayPal.
"""
...
def expected_apps(apps):
    app_ids = [1, 2, 4, 5, 6, 7, 8, 10, 11, 12, 13, 14, 15, 16]
    expected_apps = []
