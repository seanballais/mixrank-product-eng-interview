...
def test_no_cursor_no_to_sdks(client, paypal_to_only_none_apps, sdk_ids):
...
def test_has_cursor_next_dir_no_to_sdks(client, paypal_to_only_none_apps,
                                        sdk_ids):
    apps = paypal_to_only_none_apps
    count = 4
    cursor = query_utils.create_app_cursor(apps[2])
...
def test_has_cursor_next_dir2_no_to_sdks(client, paypal_to_only_none_apps,
                                         sdk_ids):
    apps = paypal_to_only_none_apps
    count = 7
    cursor = query_utils.create_app_cursor(apps[4])
...
def test_has_cursor_prev_dir_no_to_sdks(client, paypal_to_only_none_apps,
                                        sdk_ids):
    apps = paypal_to_only_none_apps
    count = 2
    cursor = query_utils.create_app_cursor(apps[3])
...
def test_has_cursor_prev_dir2_no_to_sdks(client, paypal_to_only_none_apps,
                                         sdk_ids):
    apps = paypal_to_only_none_apps
    count = 5
    cursor = query_utils.create_app_cursor(apps[1])
...
def test_has_cursor_no_dir_no_to_sdks(client, paypal_to_only_none_apps,
                                      sdk_ids):
    apps = paypal_to_only_none_apps
    count = 2
    cursor = query_utils.create_app_cursor(apps[2])
